...
df_stats(~ fruit_day + fruit_c, data = c4im) |> gt() |>
...
```{r}
#| echo: true
m2 <- lm(1000/bmi ~ fruit_c + exerany + health, data = train_c4im)
```
...
- Submit [Lab 2](https://thomaselove.github.io/432-2024/lab2.html) to Canvas by Tuesday 2024-01-30 at Noon.
